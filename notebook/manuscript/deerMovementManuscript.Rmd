...
This resulted in `r sum(trackingSummary$nFixes)` location fixes, with a mean of `r meanDatapointsInText` per individuals, spread across an mean of `r meanDurationInText` days per individual.
