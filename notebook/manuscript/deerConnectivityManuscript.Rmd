...
For the Roe Deer we made use of previously conducted analysis on their movements that aimed to dertmeine their preference for various land use types, as well as how their movements are altered when within them <CITE>.
...
We used the biomod2 package to manage species distrbution modelling. 
...
We did not have comparable road crossing data for the rodents, meaning that their conductance raster equalled one describing probability of occurence. 
