...
We downloaded all records within the UK, for all species, resulting in `r nrow(tar_occData_fallow)` occurrence locations of Fallow Deer and `r nrow(tar_occData_rodent)` for rodents (`r table(tar_occData_rodent$species)[["Myodes glareolus"]]` *Myodes glareolus*; `r table(tar_occData_rodent$species)[["Apodemus flavicollis"]]` *Apodemus flavicollis*; `r table(tar_occData_rodent$species)[["Apodemus sylvaticus"]]` *Apodemus sylvaticus*; `r table(tar_occData_rodent$species)[["Sciurus carolinensis"]]` *Sciurus carolinensis*; `r table(tar_occData_rodent$species)[["Sciurus vulgaris"]]` *Sciurus vulgaris*).
...
For the Fallow Deer their mean home range suggested a search radius of 1500m<!-- draw from inputList ideally -->; whereas for Rodents a search radius of 150m<!-- draw from inputList ideally --> was chosen.
