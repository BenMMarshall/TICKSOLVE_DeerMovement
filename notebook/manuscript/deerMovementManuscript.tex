...
\midrule
\cellcolor{gray!10}{Aberdeenshire} & \cellcolor{gray!10}{Gask Wood} & \cellcolor{gray!10}{Roe01\_F} & \cellcolor{gray!10}{252.50} & \cellcolor{gray!10}{1799} & \cellcolor{gray!10}{7.12} & \cellcolor{gray!10}{3.37 ±1.49}\\
Aberdeenshire & Gask Wood & Roe02\_F & 255.50 & 1805 & 7.06 & 3.4 ±1.61\\
\cellcolor{gray!10}{Aberdeenshire} & \cellcolor{gray!10}{Gask Wood} & \cellcolor{gray!10}{Roe04\_F} & \cellcolor{gray!10}{248.50} & \cellcolor{gray!10}{1787} & \cellcolor{gray!10}{7.19} & \cellcolor{gray!10}{3.34 ±1.45}\\
Aberdeenshire & Muir of Dinnet & Roe05\_F & 101.88 & 676 & 6.64 & 3.62 ±1.18\\
\cellcolor{gray!10}{Aberdeenshire} & \cellcolor{gray!10}{Moss of air} & \cellcolor{gray!10}{Roe06\_F} & \cellcolor{gray!10}{282.50} & \cellcolor{gray!10}{1938} & \cellcolor{gray!10}{6.86} & \cellcolor{gray!10}{3.5 ±1.57}\\
\addlinespace
Aberdeenshire & Gask Wood & Roe08\_M & 250.50 & 1799 & 7.18 & 3.34 ±1.42\\
\cellcolor{gray!10}{Aberdeenshire} & \cellcolor{gray!10}{Black Hillocks} & \cellcolor{gray!10}{Roe09\_M} & \cellcolor{gray!10}{254.50} & \cellcolor{gray!10}{1821} & \cellcolor{gray!10}{7.16} & \cellcolor{gray!10}{3.36 ±1.44}\\
Aberdeenshire & Muir of Dinnet & Roe10\_F & 270.50 & 1873 & 6.92 & 3.47 ±1.6\\
\cellcolor{gray!10}{Aberdeenshire} & \cellcolor{gray!10}{Well House Wood} & \cellcolor{gray!10}{Roe11\_F} & \cellcolor{gray!10}{67.88} & \cellcolor{gray!10}{548} & \cellcolor{gray!10}{8.07} & \cellcolor{gray!10}{2.98 ±0.15}\\
Aberdeenshire & Well House Wood & Roe12\_F & 139.88 & 1120 & 8.01 & 3 ±0.21\\
\addlinespace
\cellcolor{gray!10}{Aberdeenshire} & \cellcolor{gray!10}{Moss of air} & \cellcolor{gray!10}{Roe13\_F} & \cellcolor{gray!10}{280.50} & \cellcolor{gray!10}{1931} & \cellcolor{gray!10}{6.88} & \cellcolor{gray!10}{3.49 ±1.53}\\
Aberdeenshire & Well House Wood & Roe14\_M & 149.88 & 1201 & 8.01 & 3 ±0.18\\
\cellcolor{gray!10}{Aberdeenshire} & \cellcolor{gray!10}{Moss of air} & \cellcolor{gray!10}{Roe15\_F} & \cellcolor{gray!10}{282.50} & \cellcolor{gray!10}{1932} & \cellcolor{gray!10}{6.84} & \cellcolor{gray!10}{3.51 ±1.59}\\
...
The code used to complete this study can be found at \url{https://github.com/BenMMarshall/TICKSOLVE_DeerMovement} amongst code for the broader examination of deer's role in these landscapes; and is archived at \url{https://doi.org/10.5281/zenodo.18701055}.

We used Blender 4.5 LTS (\citeproc{ref-blender_2025}{Blender Online Community, 2025}) and Affinity Publisher 2 (\citeproc{ref-serif_affinity_2025}{Serif, 2025}) to create the graphical abstract visuals.

\subsection{Data availability}\label{data-availability}

Core data underlying these analyses can be found at: \url{https://doi.org/10.5281/zenodo.18699746}.

Aberdeenshire Roe Deer movement data can be accessed via Movebank \url{https://www.movebank.org}; Movebank ID 2890266958.

New Forest, Hampshire Roe Deer movement data can be accessed via Movebank \url{https://www.movebank.org}; Movebank ID 8086497234.
...
\caption{\label{tab:poisTable}All fixed coefficients from the Poisson population-level habitat selection model. Significance based on whether CI overlap zero.}\\
\toprule
Variable & Mean Estimate & Standard Deviation & Lower CI & Upper CI & Significance\\
\midrule
\endfirsthead
\caption[]{\label{tab:poisTable}All fixed coefficients from the Poisson population-level habitat selection model. Significance based on whether CI overlap zero. \textit{(continued)}}\\
\toprule
Variable & Mean Estimate & Standard Deviation & Lower CI & Upper CI & Significance\\
\midrule
\endhead
...
\caption{\label{tab:sffTable}All fixed coefficients from the individual-level habitat selection models. Significance based on whether CI overlap zero. Individual estimates that were NA have been filtered out.}\\
\toprule
...
\begin{table}[!h]
\centering
\caption{\label{tab:sffPopTable}Resulting coefficients from the population mean selection from all the individual-level habitat selection models. Significance based on whether CI overlap zero. Individual estimates that were NA have been filtered out.}
\centering
