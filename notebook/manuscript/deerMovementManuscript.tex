...
The study of these processes --i.e.~habitat selection and movement-- provides insights into the dynamic relationship between an animals' physiology and the set of resources and risks occurring in landscapes (\citeproc{ref-manly_resource_1993}{Manly, McDonald \& Thomas, 1993}).
These species-habitat relationships not only determine the spatial distribution of populations, but also fundamentally underpin demographic performance (\citeproc{ref-matthiopoulos_establishing_2015}{Matthiopoulos et al., 2015}).
...
Similarly, mammal home range sizes are roughly five times smaller in areas with high versus low human disturbance (\citeproc{ref-broekman_environmental_2024}{Broekman et al., 2024}).
...
Even in the absence of concrete information on deer movements, myriad management interventions are levied at controlling deer space use and population density, depending on the local management objectives (\citeproc{ref-pepper_management_2020}{Pepper, Barbour \& Glass, 2020}).
...
While there is a long history of individual-level tracking of deer in mainland Europe and North America (\citeproc{ref-morellet_seasonality_2013}{Morellet et al., 2013}), only a handful of similar studies have been carried out on British deer, with most research attention in the UK focused on upland red deer.
Comparatively, Roe Deer (\emph{Capreolus capreolus}) remain understudied in parts of the UK such as Scotland (\citeproc{ref-mitchell1977ecology}{Mitchell, Staines \& Welch, 1977}) despite being the most abundant species in the UK and the one living most closely with humans.

Roe deer are the smallest native deer species in the United Kingdom and the most ubiquitous, covering almost all the British mainland from the northern highlands of Scotland to southern Wessex in England (\citeproc{ref-burbaitee2009roe}{Burbaiteė \& Csányi, 2009}).
...
\item
  Black Hillocks is managed by the Glendye Estate and includes a patch of coniferous forest dominated by Scot's Pine (\emph{Pinus sylvestris}) and European larch, \emph{Larix decidua}, surrounded by open upland heathland.
...
\item
  Wellhouse Woods is a commercial Sitka spruce (\emph{Picea sitchensis}) plantation surrounded by farmland pasture.
\item
...
To capture deer we employed a ``long net'' capture method (\citeproc{ref-cockburn_comparative_1979}{Cockburn, Fleming \& Wainer, 1979}), which has been used extensively and safely to capture Roe Deer in the UK (\citeproc{ref-gill_changes_1996}{Gill et al., 1996}) and elsewhere (\citeproc{ref-morellet_effect_2009}{Morellet et al., 2009}).
...
After \textasciitilde20 minutes, we removed the animal from the box and deployed the collar and ear tag.

We fitted captured adult Roe Deer with GPS-collared (30mm reinforced Tellus GP Light Iridium by Followit) that weighed 276g, representing \textless2\% of the deer total body mass.
Collars collected GPS fixes every 3 hours in Aberdeenshire.
In Wessex the collar fix frequency set to to every 30 minutes.
Collars in Wessex were detached after a short duration (\textasciitilde1 month) due to evidence from one animal that the collar may have caused some friction to the neck.
As a result, the Wessex dataset is more limited in overall duration.

\begin{figure}[h]
\includegraphics[width=0.75\linewidth]{../../figures/studyLocationMapRoe} \caption{ Locations of the study sites in Aberdeenshire and Wessex. Points show the mean location of GPS collared Roe Deer. Green areas in right panel depict woodland, and grey lines show roads. All maps are north orientated.}\label{fig:studyLocationMapRoe}
\end{figure}

\begin{table}[!h]
\centering
\caption{\label{tab:trackingSummaryTable}Summary of tracking data used in analysis.}
\centering
\begin{tabular}[t]{llrrrl}
\toprule
Location & Deer ID & Duration (days) & Number of fixes & Fixes per day & Mean time lag between fixes (hours)\\
\midrule
\cellcolor{gray!10}{Aberdeenshie} & \cellcolor{gray!10}{Roe01\_F} & \cellcolor{gray!10}{252.50} & \cellcolor{gray!10}{1799} & \cellcolor{gray!10}{7.12} & \cellcolor{gray!10}{3.37 ±1.49}\\
Aberdeenshie & Roe02\_F & 255.50 & 1805 & 7.06 & 3.4 ±1.61\\
\cellcolor{gray!10}{Aberdeenshie} & \cellcolor{gray!10}{Roe04\_F} & \cellcolor{gray!10}{248.50} & \cellcolor{gray!10}{1787} & \cellcolor{gray!10}{7.19} & \cellcolor{gray!10}{3.34 ±1.45}\\
Aberdeenshie & Roe05\_F & 101.88 & 676 & 6.64 & 3.62 ±1.18\\
\cellcolor{gray!10}{Aberdeenshie} & \cellcolor{gray!10}{Roe06\_F} & \cellcolor{gray!10}{282.50} & \cellcolor{gray!10}{1938} & \cellcolor{gray!10}{6.86} & \cellcolor{gray!10}{3.5 ±1.57}\\
\addlinespace
Aberdeenshie & Roe08\_M & 250.50 & 1799 & 7.18 & 3.34 ±1.42\\
\cellcolor{gray!10}{Aberdeenshie} & \cellcolor{gray!10}{Roe09\_M} & \cellcolor{gray!10}{254.50} & \cellcolor{gray!10}{1821} & \cellcolor{gray!10}{7.16} & \cellcolor{gray!10}{3.36 ±1.44}\\
Aberdeenshie & Roe10\_F & 270.50 & 1873 & 6.92 & 3.47 ±1.6\\
\cellcolor{gray!10}{Aberdeenshie} & \cellcolor{gray!10}{Roe11\_F} & \cellcolor{gray!10}{67.88} & \cellcolor{gray!10}{548} & \cellcolor{gray!10}{8.07} & \cellcolor{gray!10}{2.98 ±0.15}\\
Aberdeenshie & Roe12\_F & 139.88 & 1120 & 8.01 & 3 ±0.21\\
\addlinespace
\cellcolor{gray!10}{Aberdeenshie} & \cellcolor{gray!10}{Roe13\_F} & \cellcolor{gray!10}{280.50} & \cellcolor{gray!10}{1931} & \cellcolor{gray!10}{6.88} & \cellcolor{gray!10}{3.49 ±1.53}\\
Aberdeenshie & Roe14\_M & 149.88 & 1201 & 8.01 & 3 ±0.18\\
\cellcolor{gray!10}{Aberdeenshie} & \cellcolor{gray!10}{Roe15\_F} & \cellcolor{gray!10}{282.50} & \cellcolor{gray!10}{1932} & \cellcolor{gray!10}{6.84} & \cellcolor{gray!10}{3.51 ±1.59}\\
Wessex & Roe03\_M & 49.88 & 305 & 6.11 & 3.94 ±1.81\\
\cellcolor{gray!10}{Wessex} & \cellcolor{gray!10}{Roe07\_F} & \cellcolor{gray!10}{52.92} & \cellcolor{gray!10}{368} & \cellcolor{gray!10}{6.95} & \cellcolor{gray!10}{3.46 ±1.67}\\
\bottomrule
\multicolumn{6}{l}{\rule{0pt}{1em}\textit{Note: }}\\
\multicolumn{6}{l}{\rule{0pt}{1em}Deer ID suffix denotes the sex of the individual deer.}\\
\end{tabular}
\end{table}

We retrieved movement data from 15 GPS collars worn by Roe Deer, 13 in Aberdeenshire, 2 in Wessex.
...
\begin{table}[!h]
\centering
\caption{\label{tab:landcoverTable}Overview of the reclassifcation of UKCEH land cover classes for inclusion into the habitat selection models.}
\centering
\begin{tabular}[t]{lrl}
\toprule
...
To account for the structure originating from having multiple individuals in the model, we included of fixed Gaussian processes for the time step and the individual in keeping with the approach described by Muff, Signer \& Fieberg (\citeproc{ref-muff_accounting_2020}{2020}).
...
The model also revealed that roads play a significant role in reducing connectivity across the landscape: observed deer steps were significantly less likely to cross roads than control steps (-0.76; 95\% CI -1.2 to -0.36).
...
Roe 10 is also likely the reason the estimated heterogeneity in response to distance to woodland (0.0134) is greater than distance to hedges (0.0019; Fig. \ref{fig:ssfHeteroPlot}).
...
This is reflected in the population mean being close to zero (-0.001; 95\% CI -0.002 to 0), while the specialisation is greater (0.002; Fig. \ref{fig:ssfSpecialPlot}), the combination of which could indicate two differing responses to hedges in the sampled Roe Deer.
...
Our findings on Roe Deer home range size are similar to those values reported in the HomeRange database for Roe Deer (Fig. \ref{fig:hrCompPlot}), with the database presenting examples of ranges larger and smaller (Broekman et al. (\citeproc{ref-broekman_homerange_2023}{2023}); Broekman et al. (\citeproc{ref-broekman_homerange_2022}{2022}); see references in data availability section).
This coherence is surprising given the rudimentary nature of the comparison that does not account for differences in sampling protocol, duration, or home range estimation method, all of which can modify estimated home range size (\citeproc{ref-silva_reptiles_2020}{Silva et al., 2020}).
As such the UK Roe Deer examined here appear largely typical in regards to their use of space.
Some of the variation in home range has been suggested to be a product of food availability and the arrangement of cover from predators (\citeproc{ref-tufto_habitat_1996}{Tufto, Andersen \& Linnell, 1996}).

Other examinations of Roe Deer have highlighted the importance of risk guiding when Roe Deer leave their core wooded range to make use of more open areas (\citeproc{ref-bonnot_interindividual_2015}{Bonnot et al., 2015}; \citeproc{ref-padie_roe_2015}{Padié et al., 2015}).
The potential benefits of managing this risk to reap the nutritional benefits afforded by open areas are apparent (\citeproc{ref-hewison_landscape_2009}{Hewison et al., 2009}), and may present a direct trade off against the risks posed by humans.
Humans are likely the UK Roe Deer's primary concern, as other predators such as Lynx, require different risk mitigating decisions, are absent (\citeproc{ref-lone_living_2014}{Lone et al., 2014}).
...
Compared to other Roe Deer examinations our studied Roe Deer may have easier access to wooded cover in a less fragmented landscape (\citeproc{ref-morellet_landscape_2011}{Morellet et al., 2011}); thereby, potentially becoming less dependent on hedgerows.
...
In Scotland, higher rates of deer-vehicle collisions appear to occur in vicinity of woodland and other semi-natural habitats (\citeproc{ref-langbein2019deer}{Langbein, 2019}).
Other examinations have highlighted the importance of road density in Roe Deer home ranges as a key predictor of road crossing frequency (\citeproc{ref-kammerle_temporal_2017}{Kämmerle et al., 2017}), further supporting the woodland-road proximity connection.
Nelli et al. (\citeproc{ref-nelli_mapping_2018}{2018}) supports also this but also suggests the likelihood of a road section experiencing collisions is additionally tied to traffic flow levels (although traffic levels fails to predict the overall count of collisions).
While urban areas tend to lower deer-vehicle collision risk, the intersection of urban and natural areas (i.e., suburban) may lead to key hotspots where both deer and traffic collide (\citeproc{ref-nelli_mapping_2018}{Nelli et al., 2018}).
...
Other Roe Deer investigations have reveal similar preferences for forest and reluctance when crossing roads (\citeproc{ref-passoni_roads_2021}{Passoni et al., 2021}), and that the risks fluctuate over the day and year (\citeproc{ref-cunningham_permanent_2022}{Cunningham et al., 2022}; \citeproc{ref-martz_crossings_2024}{Märtz, Brieger \& Bhardwaj, 2024}).
...
This research forms part of the TickSolve project (\url{https://ticksolve.ceh.ac.uk/}) and was funded by UK Research and Innovation through the NERC grant \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_.
...
New Forest Roe Deer movement data can be accessed via Movebank (\url{https://www.movebank.org}); Movebank ID \textbar\textbar\textbar\textbar\textbar{} TBC \textbar\textbar\textbar\textbar\textbar.
...
\begin{figure}[h]
\includegraphics[width=0.75\linewidth]{../../figures/trackingDuration} \caption{Dates of data collection and overall duration or deer tracking by individual.}\label{fig:trackingDuration}
\end{figure}

\begin{figure}[h]
\includegraphics[width=0.75\linewidth]{../../figures/trackingTimelag} \caption{Distribution of time lags between Roe Deer location fixes. N.b. x axis is log scaled.}\label{fig:trackingTimelags}
\end{figure}

\begin{figure}[h]
\includegraphics[width=0.75\linewidth]{../../figures/varioRoePlot} \caption{Variograms showing the autocorrelative structure of the Roe Deer movement data; The semi-variance (average square displacement) is show over a specific time lag. Examination reveals the level of range residency displayed by each individual (i.e., flattens to an asymptote). }\label{fig:variogramPlot}
\end{figure}
...
\midrule
\cellcolor{gray!10}{Wessex} & \cellcolor{gray!10}{Fallow02\_F} & \cellcolor{gray!10}{359.01} & \cellcolor{gray!10}{265.48} & \cellcolor{gray!10}{466.44} & \cellcolor{gray!10}{0.90} & \cellcolor{gray!10}{48.86} & \cellcolor{gray!10}{OUF anisotropic}\\
Wessex & Fallow02\_F & 527.04 & 389.73 & 684.75 & 0.95 & 48.86 & OUF anisotropic\\
\cellcolor{gray!10}{Wessex} & \cellcolor{gray!10}{Fallow02\_F} & \cellcolor{gray!10}{843.98} & \cellcolor{gray!10}{624.10} & \cellcolor{gray!10}{1096.54} & \cellcolor{gray!10}{0.99} & \cellcolor{gray!10}{48.86} & \cellcolor{gray!10}{OUF anisotropic}\\
Wessex & Fallow07\_F & 3552.06 & 1051.16 & 7547.94 & 0.90 & 4.42 & OU anisotropic\\
\cellcolor{gray!10}{Wessex} & \cellcolor{gray!10}{Fallow07\_F} & \cellcolor{gray!10}{4492.18} & \cellcolor{gray!10}{1329.36} & \cellcolor{gray!10}{9545.63} & \cellcolor{gray!10}{0.95} & \cellcolor{gray!10}{4.42} & \cellcolor{gray!10}{OU anisotropic}\\
\addlinespace
Wessex & Fallow07\_F & 6604.65 & 1954.50 & 14034.53 & 0.99 & 4.42 & OU anisotropic\\
...
\bibitem[\citeproctext]{ref-cockburn_comparative_1979}
Cockburn A, Fleming M, Wainer J. 1979. The comparative effectiveness of drift fence pitfall trapping and conventional cage trapping of vertebrates in the big desert, north-western {Victoria}. \emph{Victorian Naturalist (Blackburn)} 963:92--95.
