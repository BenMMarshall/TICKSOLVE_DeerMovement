...
We used the reformulated Poisson model approach described by Muff et al to generate estimates of habitat selection as well as gauge deer's movement capabilities in relation to different aspects of the landscape.
...
First was the land use type as described by the 2023 UKCEH land cover maps, which is a 25m resolution classified raster originally based on Sentinel-2 imagery .
Validation of these data suggest 83\% accuracy .
The UKCEH land cover data comprises of 21 land cover classes, broadly following the Biodiversity Broad Habitats .
...
In addition to land use types, we also acquired woody linear feature (i.e., hedgerows) data from UKCEH .
This dataset maps the woody linear features across the UK (e.g., woodland) as polylines, based on Ordnance Survey maps and the 2007 UKCEH Land Cover Map .
...
We acquired road data from OS map open GOV licensed .
...
This formulation, namely the fixed Gaussian processes, as described by Muff et al allows for the efficient estimation of population level selection using integrated nested Laplace approximation (INLA) .
...
For our Aberdeen Roe Deer home range sizes ranged from 32.2 to 122.5, with a weighted mean of 65.3 ha (95\% CI 55.5-75.8).
Largely the deer appeared range resident; however, a couple of individuals may show evidence of a range shift during the tracking period.
...
Bakka H, Rue H, Fuglstad G-A, Riebler AI, Bolin D, Illian J, Krainski E, Simpson DP, Lindgren FK. 2018. \href{http://arxiv.org/abs/1802.06350}{Spatial modelling with {INLA}: {A} review}. \emph{WIRES (Invited extended review)} xx:xx--xx.
...
De Coninck A, De Baets B, Kourounis D, Verbosio F, Schenk O, Maenhout S, Fostier J. 2016. {Needles}: Toward large-scale genomic prediction with marker-by-environment interaction. \emph{Genetics} 203:543--555. DOI: \href{https://doi.org/10.1534/genetics.115.179887}{10.1534/genetics.115.179887}.
...
Verbosio F, De Coninck A, Kourounis D, Schenk O. 2017. \href{https://doi.org/10.1016/j.jocs.2017.08.013}{Enhancing the scalability of selected inversion factorization algorithms in genomic prediction}. \emph{Journal of Computational Science} 22:99--108.
