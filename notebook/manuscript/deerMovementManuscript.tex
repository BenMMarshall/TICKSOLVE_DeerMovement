...
Movement ecology, step selection function, habitat preference, habitat selection, animal movement, Roe Deer, Capreolus capreolus, road crossing
...
We captured deer using long netting from January to September of 2023 in Aberdeenshire, and between \_\_ and \_\_ in Wessex.

To capture deer we employed a ``long net'' capture method (Cockburn 1979) , which has been used extensively and safely to capture Roe Deer in the UK (\citeproc{ref-gill_changes_1996}{Gill et al., 1996}) and elsewhere (\citeproc{ref-morellet_effect_2009}{Morellet et al., 2009}).
...
The population habitat selection model also revealed significant selection for the land cover classes open shrubland (1.5; 95\% CI 0.62 to 2.2) and tall grassland (0.57; 95\% CI 0.17 to 0.98); other relationships were less clear.
...
Some of the variation in home range has been suggested to be a product fo food availability and the arrangement of cover from predators (\citeproc{ref-tufto_habitat_1996}{Tufto, Andersen \& Linnell, 1996}).
...
The potential benefits of managing this risk to reap the nutritional benefits afforded by open areas are apparent (\citeproc{ref-hewison_landscape_2009}{Hewison et al., 2009}), and may present a direct trade off against the risks poised by humans.
