...
Animal responses to landscapes can be hard to predict \emph{a priori}.
...
Humans are likely the UK Roe Deer's primary concern, as other predators such as Lynx, which require different risk mitigating decisions, are absent (\citeproc{ref-lone_living_2014}{Lone et al., 2014}).
