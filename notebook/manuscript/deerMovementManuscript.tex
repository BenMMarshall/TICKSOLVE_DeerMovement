...
Movement ecology, step selection function, poisson, habitat preference, habitat selection, animal movement, roe deer, Capreolus capreolus
...
\midrule
\cellcolor{gray!10}{Roe01\_F} & \cellcolor{gray!10}{252.50} & \cellcolor{gray!10}{1799} & \cellcolor{gray!10}{7.12} & \cellcolor{gray!10}{3.37 ±1.49}\\
Roe02\_F & 255.50 & 1805 & 7.06 & 3.4 ±1.61\\
\cellcolor{gray!10}{Roe03\_M} & \cellcolor{gray!10}{49.88} & \cellcolor{gray!10}{305} & \cellcolor{gray!10}{6.11} & \cellcolor{gray!10}{3.94 ±1.81}\\
Roe04\_F & 248.50 & 1787 & 7.19 & 3.34 ±1.45\\
\cellcolor{gray!10}{Roe05\_F} & \cellcolor{gray!10}{101.88} & \cellcolor{gray!10}{676} & \cellcolor{gray!10}{6.64} & \cellcolor{gray!10}{3.62 ±1.18}\\
\addlinespace
Roe06\_F & 282.50 & 1938 & 6.86 & 3.5 ±1.57\\
\cellcolor{gray!10}{Roe07\_F} & \cellcolor{gray!10}{52.92} & \cellcolor{gray!10}{368} & \cellcolor{gray!10}{6.95} & \cellcolor{gray!10}{3.46 ±1.67}\\
Roe08\_M & 250.50 & 1799 & 7.18 & 3.34 ±1.42\\
\cellcolor{gray!10}{Roe09\_M} & \cellcolor{gray!10}{254.50} & \cellcolor{gray!10}{1821} & \cellcolor{gray!10}{7.16} & \cellcolor{gray!10}{3.36 ±1.44}\\
Roe10\_F & 270.50 & 1873 & 6.92 & 3.47 ±1.6\\
\addlinespace
\cellcolor{gray!10}{Roe11\_F} & \cellcolor{gray!10}{67.88} & \cellcolor{gray!10}{548} & \cellcolor{gray!10}{8.07} & \cellcolor{gray!10}{2.98 ±0.15}\\
Roe12\_F & 139.88 & 1120 & 8.01 & 3 ±0.21\\
\cellcolor{gray!10}{Roe13\_F} & \cellcolor{gray!10}{280.50} & \cellcolor{gray!10}{1931} & \cellcolor{gray!10}{6.88} & \cellcolor{gray!10}{3.49 ±1.53}\\
Roe14\_M & 149.88 & 1201 & 8.01 & 3 ±0.18\\
\cellcolor{gray!10}{Roe15\_F} & \cellcolor{gray!10}{282.50} & \cellcolor{gray!10}{1932} & \cellcolor{gray!10}{6.84} & \cellcolor{gray!10}{3.51 ±1.59}\\
\bottomrule
\multicolumn{5}{l}{\rule{0pt}{1em}\textit{Note: }}\\
\multicolumn{5}{l}{\rule{0pt}{1em}Deer ID suffix denote the sex of the individual deer.}\\
\end{tabular}
\end{table}

We retrieved movement data from 15 GPS collars worn by Roe Deer, 13 in Aberdeen, 2 in Wessex.
...
This resulted in 20903 location fixes, with a mean of 1394 SD±627.9 per individuals, spread across an mean of 196 SD±90.99 days per individual.
Overall this resulted in an average of 7.133 SD±0.5359 fixes per day per individual.
...
\begin{figure}[h]
\includegraphics[width=0.75\linewidth]{../../figures/trackingTimelag} \caption{Distribution of time lags after resampling and filtering. N.b. x axis is log scaled.}\label{fig:trackingTimelags}
\end{figure}
...
\begin{figure}[h]
\includegraphics[width=0.75\linewidth]{../../figures/distanceDistributionPlot} \caption{Distribution of the distances deer locations were from patches when outside of a patch.}\label{fig:distanceDistributionPlot}
\end{figure}
...
For our Aberdeen Roe Deer home range sizes ranged from 32.2 to 122.5ha (95\% contour point estimates), with a weighted mean of 65.3 ha (95\% CI 55.5-75.8) (Fig. \ref{fig:homeRangeSize}).
...
\begin{figure}[h]
\includegraphics[width=0.75\linewidth]{../../figures/homeRangeAreaPlot} \caption{Home range size as estimated via the Autocorrelated Kernel Density Estimators. Depicted are the 95\% contour with 95\% confidence intervals surrounding that estimate. The vertical line shows the naive mean of all home range estimates.}\label{fig:homeRangeSize}
\end{figure}

\begin{figure}[h]
\includegraphics[width=0.75\linewidth]{../../figures/varioRoePlot} \caption{Variograms showing the autocorrelative structure of the Roe Deer movement data, revealing the level of range residency each individual displayed.}\label{fig:variogramPlot}
\end{figure}
...
These step lengths in these land uses to be lower, as seen in coeficeints for log step length (; short grassland -0.76; 95\% CI -1.2 to -0.32; tall grassland -0.18; 95\% CI -0.25 to -0.12; cropland -0.16; 95\% CI -0.24 to -0.076) but with a larger tail to the gamma distribution (i.e, larger coefficient for step lengths (short grassland 0.0044; 95\% CI 0.0018 to 0.007; tall grassland 0.00049; 95\% CI 5.4e-05 to 0.00092; cropland 0.0012; 95\% CI 0.00064 to 0.0017).
...
\begin{figure}[h]
\includegraphics[width=1\linewidth]{../../figures/poisCoef} \caption{Coefficient estimates, with 95\% confidence intervals, from the Poisson model of habitat selection. Major outlying estimates have been replaced with labels to aid visualisation. Colour highlights and bolding reflect the significantly negative (light orange) and significantly positive (dark orange) coefficients.}\label{fig:poisCoefPlot}
\end{figure}
