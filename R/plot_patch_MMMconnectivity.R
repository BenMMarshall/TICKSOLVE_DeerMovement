...
#'
#' @name plot_patch_MMMconnectivity
#' @description abc
#' @return abc
#'
#' @export
plot_patch_MMMconnectivity <- function(MSEdf, connectRasterLocations, patchList, selectedPatchList, REGION){
  ...
  ggsave(plot = comboPlot, filename = here::here("figures", paste0("patchConnectivity_MMM_", method, "_", REGION, ".png")),
         width = 220, height = 180, units = "mm", dpi = 300)
  ggsave(plot = comboPlot, filename = here::here("figures", paste0("patchConnectivity_MMM_", method, "_", REGION, ".pdf")),
